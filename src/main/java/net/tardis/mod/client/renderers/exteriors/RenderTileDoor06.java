...
import net.tardis.mod.client.models.exteriors.ModelTardis06;
...
public class RenderTileDoor06 extends RenderExterior {

	public static final ResourceLocation TEXTURE = new ResourceLocation(Tardis.MODID, "textures/exteriors/06.png");
			//
	private static Vec3d SIZE = new Vec3d(1.1, 2.2, 0);
	private RenderWorldShell renderShell = new RenderWorldShell();
	private ModelTardis06 model = new ModelTardis06();
